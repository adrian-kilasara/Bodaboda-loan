...
<div class="py-6 max-w-3xl" x-data="contractForm()">
    <div class="bg-white rounded-xl border border-neutral-100 p-6">
        <form method="POST" action="{{ route('contracts.store') }}" class="space-y-6">
            ...
            {{-- Step 1: Motorcycle --}}
            <div>
                <h2 class="text-sm font-semibold uppercase text-neutral-500 tracking-wide mb-3">1 — Select Motorcycle</h2>
                @if($motorcycles->isEmpty())
                    <div class="bg-accent-light border border-accent rounded-lg px-4 py-3 text-sm text-neutral-700">
                        No available motorcycles.
                        <a href="{{ route('motorcycles.create') }}" class="text-primary font-medium hover:underline">Add one first →</a>
                    </div>
                @else
            ...
            <div>
                <h2 class="text-sm font-semibold uppercase text-neutral-500 tracking-wide mb-3">2 — Loan Terms</h2>
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col justify-end">
                        <div class="bg-primary-light rounded-lg px-4 py-3">
            ...
            {{-- Step 3: Schedule --}}
            <div>
                <h2 class="text-sm font-semibold uppercase text-neutral-500 tracking-wide mb-3">3 — Installment Schedule</h2>
                <div class="grid grid-cols-2 gap-5">
                    <div>
                ...
                <template x-if="scheduleRows.length > 0">
                    <div class="mt-4 border border-primary rounded-xl overflow-hidden">
                        <div class="bg-primary-light px-4 py-2 flex items-center justify-between">
                            <span class="text-xs font-semibold text-primary uppercase">Schedule Preview (first 10)</span>
            ...
            {{-- Step 4: Penalty --}}
            <div>
                <h2 class="text-sm font-semibold uppercase text-neutral-500 tracking-wide mb-3">4 — Penalty (optional)</h2>
            ...
            <div class="flex gap-3 pt-2">
                <button type="submit" class="btn-primary" :disabled="motorcycles && installmentAmount > 0 && count > 0 ? false : false">
