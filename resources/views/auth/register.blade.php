...
<body class="bg-neutral-100 font-sans min-h-screen flex items-center justify-center py-8">
<div class="w-full max-w-sm px-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-6">
        <h2 class="text-lg font-semibold mb-5">Create your account</h2>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="relative cursor-pointer">
                        ...
                        <div class="border-2 border-neutral-200 rounded-xl p-3 text-center peer-checked:border-primary peer-checked:bg-primary-light transition-colors">
                            <svg class="w-6 h-6 mx-auto mb-1 text-neutral-400 peer-checked:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                            </svg>
                            <span class="text-sm font-medium">Bike Owner</span>
                        </div>
                    </label>
                    <label class="relative cursor-pointer">
                        ...
                        <div class="border-2 border-neutral-200 rounded-xl p-3 text-center peer-checked:border-primary peer-checked:bg-primary-light transition-colors">
                            <svg class="w-6 h-6 mx-auto mb-1 text-neutral-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
